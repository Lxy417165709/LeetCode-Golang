...
1. 代码
    ...
    4. 二叉树结构调整
        ...
        3. 二叉树展开为链表
            ...
            ```
        4. 合并二叉树 ([传送站](https://leetcode-cn.com/problems/merge-two-binary-trees/))
            ```go
            ...
            ```
        5. 将二叉搜索树转换为累加树 ([传送站](https://leetcode-cn.com/problems/convert-bst-to-greater-tree/comments/))
            ```go
            ...
            ```
            6. 删除二叉树值为目标值的节点，返回删除后形成的森林([传送站](https://leetcode-cn.com/problems/delete-nodes-and-return-forest/submissions/))
                ``` go
                var forest []*TreeNode
